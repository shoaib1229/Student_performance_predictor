import subprocess #The subprocess module allows you to spawn new processes, connect to their input/output/error 
import wolframalpha #Wolfram|Alpha is a search engine that computes expert-level answers using algorithms and AI
import wikiquote #Wikiquote is a free online compendium of sourced quotations from notable people
import pyttsx3 #pyttsx3 is a Python library that allows you to convert text to speech offline
import json
